                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Vous etes un client de waclo ? créer votre compte gratuitement</p>
                                    </div>

                                    <form class="row g-3 needs-validation" method="post" action="{{route('register')}}" >
                                        @csrf
                                        <div class="col-12">
                                            <label for="yourName" class="form-label">Pseudo ou Nom Société</label>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Vous avez deja un compte? <a
