...
<head>
    ...
    <title>Waclo / Login - NiceAdmin Bootstrap Template</title>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <!--div>
                                <img style="width: 150px"  src="http://127.0.0.1:8000/assets/img/logo-c.png" alt="">
                            </div-->
                            <div class="d-flex justify-content-center py-4">
                                <a href="{{route('index')}}" class="logo d-flex align-items-center w-auto">
                                    <img  src="{{asset('assets/img/logo-c.png')}}" alt="">
                                    <span class="d-none d-lg-block">WACLO AGENT</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Agent sociéte</h5>
                                    ...
                                    <form class="row g-3 needs-validation" method="POST" action="{{route('agent.login')}}" >
                                        ...
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Email ou Télephone</label>
