...
<li class="nav-item">
    ...
    <ul id="devis-demande" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
            <a href="{{route('admin.devis.new')}}">
...
<li class="nav-item">
    ...
    <ul id="forms-nav" class="nav-content   " data-bs-parent="#sidebar-nav">
        <li>
            <a href="{{route('admin.employes.liste')}}">
                <i class="bi bi-circle"></i><span>Liste des employés</span>
            </a>
        </li>
        <li>
            <a href="{{route('admin.employes.new')}}">
...
<li class="nav-item">
    ...
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
            <a href="{{route('admin.clients.mesclients')}}">
                <i class="bi bi-circle"></i><span>Liste des clients</span>
            </a>
        </li>
        <li>
            <a href="{{route('admin.clients.new')}}">
                <i class="bi bi-circle"></i><span>Enregistrer</span>
            </a>
        </li>
    </ul>
...
<li class="nav-item">
    ...
    <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
            <a href="{{route('admin.travaux.new')}}">
                <i class="bi bi-circle"></i><span>Enregistrer</span>
            </a>
        </li>
        <li>
            <a href="{{route('admin.travaux.encours')}}">
                <i class="bi bi-circle"></i><span>Travaux en cours</span>
            </a>
        </li>
        <li>
            <a href="{{route('admin.travaux.historique')}}">
...
<li class="nav-item">
    ...
    <ul id="entrees" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
            <a href="{{route('admin.collabo.new')}}">
                <i class="bi bi-circle"></i><span>Enregistrer un nouveau</span>
            </a>
        </li>
        <li>
            <a href="{{route('admin.collabo.liste')}}">
